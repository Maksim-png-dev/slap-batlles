...
loadstring(game:HttpGet("https://raw.githubusercontent.com/vitorsla123/slap-batlles/main/Slap_Battles.lua"))()
    ]])
else
...
local Window = OrionLib:MakeWindow({IntroText = "Slap Battles 👏", IntroIcon = "rbxassetid://15315284749",Name = ("Slayer hub - Slap Battles 👏".." | ".. identifyexecutor()),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
